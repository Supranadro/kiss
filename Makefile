...
pkgdatadir = $(datadir)/kiss
pkgincludedir = $(includedir)/kiss
pkglibdir = $(libdir)/kiss
pkglibexecdir = $(libexecdir)/kiss
...
CONFIG_HEADER = $(top_builddir)/src/config/kiss-config.h
...
am__DIST_COMMON = $(srcdir)/Makefile.in \
	...
	$(top_srcdir)/src/config/kiss-config.h.in \
...
ACLOCAL = ${SHELL} /home/aziz/Desktop/picture/Kiss918code/build-aux/missing aclocal-1.15
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 0
AR = /usr/bin/ar
AUTOCONF = ${SHELL} /home/aziz/Desktop/picture/Kiss918code/build-aux/missing autoconf
AUTOHEADER = ${SHELL} /home/aziz/Desktop/picture/Kiss918code/build-aux/missing autoheader
AUTOMAKE = ${SHELL} /home/aziz/Desktop/picture/Kiss918code/build-aux/missing automake-1.15
AWK = mawk
BDB_CPPFLAGS = 
...
MAINT = 
MAKEINFO = ${SHELL} /home/aziz/Desktop/picture/Kiss918code/build-aux/missing makeinfo
MAKENSIS = 
MANIFEST_TOOL = :
MINIUPNPC_CPPFLAGS = 
...
OTOOL64 = 
PACKAGE = kiss
PACKAGE_BUGREPORT = www.kiss.org
PACKAGE_NAME = Kiss Core
PACKAGE_STRING = Kiss Core 1.1.0
PACKAGE_TARNAME = kiss
PACKAGE_URL = 
...
ZMQ_CFLAGS = 
ZMQ_LIBS = 
abs_builddir = /home/aziz/Desktop/picture/Kiss918code
abs_srcdir = /home/aziz/Desktop/picture/Kiss918code
abs_top_builddir = /home/aziz/Desktop/picture/Kiss918code
abs_top_srcdir = /home/aziz/Desktop/picture/Kiss918code
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_CXX = g++
ac_ct_DUMPBIN = 
...
install_sh = ${SHELL} /home/aziz/Desktop/picture/Kiss918code/build-aux/install-sh
...
SUBDIRS = src
BITCOIND_BIN = $(top_builddir)/src/kissd$(EXEEXT)
BITCOIN_QT_BIN = $(top_builddir)/src/qt/kiss-qt$(EXEEXT)
BITCOIN_CLI_BIN = $(top_builddir)/src/kiss-cli$(EXEEXT)
...
COVERAGE_INFO = baseline_filtered_combined.info baseline.info block_test.info \
  leveldb_baseline.info test_kiss_filtered.info total_coverage.info \
  baseline_filtered.info block_test_filtered.info \
  leveldb_baseline_filtered.info test_kiss_coverage.info test_kiss.info

OSX_APP_BUILT = $(OSX_APP)/Contents/PkgInfo $(OSX_APP)/Contents/Resources/empty.lproj \
  $(OSX_APP)/Contents/Resources/bitcoin.icns $(OSX_APP)/Contents/Info.plist \
  $(OSX_APP)/Contents/MacOS/Kiss-Qt $(OSX_APP)/Contents/Resources/Base.lproj/InfoPlist.strings
...
src/config/kiss-config.h: src/config/stamp-h1
	@test -f $@ || rm -f src/config/stamp-h1
	@test -f $@ || $(MAKE) $(AM_MAKEFLAGS) src/config/stamp-h1

src/config/stamp-h1: $(top_srcdir)/src/config/kiss-config.h.in $(top_builddir)/config.status
	@rm -f src/config/stamp-h1
	cd $(top_builddir) && $(SHELL) ./config.status src/config/kiss-config.h
$(top_srcdir)/src/config/kiss-config.h.in:  $(am__configure_deps) 
	($(am__cd) $(top_srcdir) && $(AUTOHEADER))
	rm -f src/config/stamp-h1
	touch $@

distclean-hdr:
	-rm -f src/config/kiss-config.h src/config/stamp-h1
...
$(OSX_APP)/Contents/MacOS/Kiss-Qt: $(BITCOIN_QT_BIN)
	$(MKDIR_P) $(@D)
...
$(APP_DIST_EXTRAS): $(APP_DIST_DIR)/$(OSX_APP)/Contents/MacOS/Kiss-Qt
...
$(APP_DIST_DIR)/$(OSX_APP)/Contents/MacOS/Kiss-Qt: $(OSX_APP_BUILT) $(OSX_PACKAGING)
...
#test_kiss.info: baseline_filtered_combined.info
#	$(MAKE) -C src/ check
#	$(LCOV) -c -d $(abs_builddir)/src -t test_kiss -o $@
#	$(LCOV) -z -d $(abs_builddir)/src
#	$(LCOV) -z -d $(abs_builddir)/src/leveldb

#test_kiss_filtered.info: test_kiss.info
#	$(LCOV) -r $< "/usr/include/*" -o $@

#block_test.info: test_kiss_filtered.info
#	$(MKDIR_P) qa/tmp
...
#test_kiss_coverage.info: baseline_filtered_combined.info test_kiss_filtered.info
#	$(LCOV) -a baseline_filtered.info -a leveldb_baseline_filtered.info -a test_kiss_filtered.info -o $@

#total_coverage.info:  baseline_filtered_combined.info test_kiss_filtered.info block_test_filtered.info
#	$(LCOV) -a baseline_filtered.info -a leveldb_baseline_filtered.info -a test_kiss_filtered.info -a block_test_filtered.info -o $@ | $(GREP) "\%" | $(AWK) '{ print substr($$3,2,50) "/" $$5 }' > coverage_percent.txt

#test_kiss.coverage/.dirstamp:  test_kiss_coverage.info
#	$(GENHTML) -s $< -o $(@D)
#	@touch $@
...
#cov: test_kiss.coverage/.dirstamp total.coverage/.dirstamp

# Kiss: disable the outdated comparison tool test
...
clean-local:
	rm -rf test_kiss.coverage/ total.coverage/ $(OSX_APP)
