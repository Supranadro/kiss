...
BOOST_AUTO_TEST_CASE(netbase_properties)
{
    ...
    BOOST_CHECK(CNetAddr("1192::1").IsRFC3964());
...
BOOST_AUTO_TEST_CASE(netbase_splithost)
{
    ...
    BOOST_CHECK(TestSplitHost("127.0.0.1:1191", "127.0.0.1", 1191));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]:1191", "127.0.0.1", 1191));
    BOOST_CHECK(TestSplitHost("::ffff:127.0.0.1", "::ffff:127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[::ffff:127.0.0.1]:1191", "::ffff:127.0.0.1", 1191));
    BOOST_CHECK(TestSplitHost("[::]:1191", "::", 1191));
    BOOST_CHECK(TestSplitHost("::1191", "::1191", -1));
    BOOST_CHECK(TestSplitHost(":1191", "", 1191));
    BOOST_CHECK(TestSplitHost("[]:1191", "", 1191));
...
BOOST_AUTO_TEST_CASE(netbase_lookupnumeric)
{
    ...
    BOOST_CHECK(TestParse("127.0.0.1:1191", "127.0.0.1:1191"));
    BOOST_CHECK(TestParse("::ffff:127.0.0.1", "127.0.0.1:65535"));
    BOOST_CHECK(TestParse("::", "[::]:65535"));
    BOOST_CHECK(TestParse("[::]:1191", "[::]:1191"));
    BOOST_CHECK(TestParse("[127.0.0.1]", "127.0.0.1:65535"));
...
{
    // values from https://web.archive.org/web/20121121191543/http://www.cypherpunk.at/onioncat/wiki/OnionCat
