                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Kiss Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Kiss address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and kiss: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Kiss Core"), this);
    aboutAction->setStatusTip(tr("Show information about Kiss Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Kiss"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Kiss addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Kiss addresses"));
    ...
    openAction->setStatusTip(tr("Open a Kiss: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Kiss Core help message to get a list with possible Kiss command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Kiss Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Kiss network", "", count));
}
...
{
    QString strTitle = tr("Kiss Core"); // default title
