...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Kiss features */
        {"kiss", "masternode", &masternode, true, true, false},
        {"kiss", "listmasternodes", &listmasternodes, true, true, false},
        {"kiss", "getmasternodecount", &getmasternodecount, true, true, false},
        {"kiss", "masternodeconnect", &masternodeconnect, true, true, false},
        {"kiss", "masternodecurrent", &masternodecurrent, true, true, false},
        {"kiss", "masternodedebug", &masternodedebug, true, true, false},
        {"kiss", "startmasternode", &startmasternode, true, true, false},
        {"kiss", "createmasternodekey", &createmasternodekey, true, true, false},
        {"kiss", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"kiss", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"kiss", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"kiss", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"kiss", "getmasternodescores", &getmasternodescores, true, true, false},
        {"kiss", "mnbudget", &mnbudget, true, true, false},
        {"kiss", "preparebudget", &preparebudget, true, true, false},
        {"kiss", "submitbudget", &submitbudget, true, true, false},
        {"kiss", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"kiss", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"kiss", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"kiss", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"kiss", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"kiss", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"kiss", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"kiss", "checkbudgets", &checkbudgets, true, true, false},
        {"kiss", "mnsync", &mnsync, true, true, false},
        {"kiss", "spork", &spork, true, true, false},
        {"kiss", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"kiss", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use kissd, or the -server option to kiss-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> kiss-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:1191/\n";
}
