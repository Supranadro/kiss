...
In order to support loading of multiple wallets in kiss-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is kiss.cpp.
...
Changes to kiss.cpp
----------------------
kiss.cpp is the entry point into kiss-qt, and as such, will require some minor modifications to provide hooks for
