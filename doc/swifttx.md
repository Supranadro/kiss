...
This mechanism has been integrated into Bitcore-Node-Kiss which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/Kiss-Project/insight-api-kiss#web-socket-api](https://github.com/Kiss-Project/insight-api-kiss#web-socket-api) 
* API: [https://github.com/Kiss-Project/insight-api-kiss#swifttx-transactions](https://github.com/Kiss-Project/insight-api-kiss#swifttx-transactions) 
...
By default, the Kiss Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Kiss Core daemon:
